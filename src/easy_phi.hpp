...
struct Vec2 {
    ...
    template <typename T> Vec2(T v) : x((ep_f64)v), y((ep_f64)v) {}
    ...
    Vec2 operator*(const Vec2& v) const noexcept { return { x * v.x, y * v.y }; }
    Vec2 operator/(const Vec2& v) const noexcept { return { x / v.x, y / v.y }; }
    Vec2 operator+(ep_f64 v) const noexcept { return { x + v, y + v }; }
    Vec2 operator-(ep_f64 v) const noexcept { return { x - v, y - v }; }
    Vec2 operator*(ep_f64 v) const noexcept { return { x * v, y * v }; }
    Vec2 operator/(ep_f64 v) const noexcept { return { x / v, y / v }; }
...
struct EaseSet {
    ...
    */
    ...
    struct Milthm {
        static ep_u64 pack(ep_u64 ease, ep_u64 press) {
            ease = std::clamp<ep_u64>(ease, 0, 2);
            press = std::clamp<ep_u64>(press, 0, 10);
            return ease << 4 | press;
        }

        static std::pair<ep_u64, ep_u64> unpack(ep_u64 packed) noexcept {
            return { packed >> 4, packed & 0b1111 };
        }
        ...
        static constexpr ep_f64 intTable[3][11][ktIntegralTableSize] = {
            {
            ...
            },
            {
                ...
                { 0, 6.35552e-13, 4.06751e-11, 4.63315e-10, 2.6032e-09, 9.93043e-09, 2.96521e-08, 7.47716e-08, 1.66605e-07, 3.37756e-07, 6.35548e-07, 1.12591e-06, 1.89774e-06, 3.06767e-06, 4.78538e-06, 7.23928e-06, 1.06627e-05, 1.53406e-05, 2.16164e-05, 2.98999e-05, 4.0675e-05, 5.45085e-05, 7.20583e-05, 9.40839e-05, 0.000121455, 0.000155163, 0.000196331, 0.000246224, 0.000306264, 0.000378039, 0.000463314, 0.000564051, 0.000682414, 0.000820789, 0.000981797, 0.00116831, 0.00138345, 0.00163064, 0.00191359, 0.00223633, 0.0026032, 0.00301892, 0.00348854, 0.00401753, 0.00461173, 0.00527744, 0.00602137, 0.0068507, 0.00777312, 0.0087968, 0.00993043, 0.0111833, 0.0125652, 0.0140865, 0.0157583, 0.0175924, 0.0196009, 0.021797, 0.0241945, 0.0268077, 0.0296521, 0.0327436, 0.0360993, 0.0397367, 0.0436737, 0.0479103, 0.0524288, 0.0572113, 0.0622409, 0.0675017, 0.0729783, 0.0786563, 0.0845218, 0.0905618, 0.096764, 0.103117, 0.109609, 0.11623, 0.12297, 0.129821, 0.136772, 0.143817, 0.150947, 0.158156, 0.165435, 0.172781, 0.180185, 0.187643, 0.19515, 0.202702, 0.210293, 0.21792, 0.225579, 0.233266, 0.240979, 0.248715, 0.256471, 0.264244, 0.272033, 0.279835, 0.287649, 0.295473, 0.303306, 0.311146, 0.318993, 0.326845, 0.334701, 0.342562, 0.350425, 0.358291, 0.366158, 0.374028, 0.381898, 0.38977, 0.397642, 0.405515, 0.413389, 0.421262, 0.429136, 0.43701, 0.444884, 0.452758, 0.460632, 0.468506, 0.47638, 0.484254, 0.492128, 0.500002 },
                { 0, 4.06242e-06, 8.59341e-06, 1.3647e-05, 1.92834e-05, 2.557e-05, 3.25816e-05, 4.04019e-05, 4.91242e-05, 5.88525e-05, 6.97029e-05, 8.18047e-05, 9.53022e-05, 0.000110357, 0.000127147, 0.000145875, 0.000166762, 0.000190058, 0.000216041, 0.000245022, 0.000277344, 0.000313395, 0.000353603, 0.00039845, 0.000448468, 0.000504256, 0.000566478, 0.000635876, 0.000713279, 0.000799609, 0.000895897, 0.00100329, 0.00112307, 0.00125666, 0.00140567, 0.00157185, 0.00175721, 0.00196395, 0.00219452, 0.0024517, 0.00273853, 0.00305845, 0.00341527, 0.00381324, 0.00425711, 0.00475218, 0.00530434, 0.0059202, 0.00660708, 0.00737319, 0.00822765, 0.00918067, 0.0102436, 0.0114291, 0.0127514, 0.0142262, 0.0158711, 0.0177057, 0.0197519, 0.022034, 0.0245795, 0.0274185, 0.0305849, 0.0341165, 0.0380536, 0.042396, 0.0471036, 0.0521386, 0.0574672, 0.0630591, 0.068887, 0.0749264, 0.0811556, 0.0875549, 0.0941066, 0.100795, 0.107606, 0.114527, 0.121547, 0.128655, 0.135842, 0.1431, 0.150422, 0.157801, 0.165231, 0.172707, 0.180224, 0.187779, 0.195366, 0.202983, 0.210626, 0.218293, 0.225982, 0.23369, 0.241415, 0.249156, 0.25691, 0.264676, 0.272454, 0.280242, 0.288039, 0.295843, 0.303655, 0.311473, 0.319297, 0.327127, 0.33496, 0.342798, 0.35064, 0.358485, 0.366333, 0.374184, 0.382037, 0.389892, 0.39775, 0.405609, 0.413469, 0.421331, 0.429194, 0.437059, 0.444924, 0.45279, 0.460657, 0.468525, 0.476393, 0.484262, 0.492132, 0.500002 },
        ...
        static ep_f64 easing_int(ep_u64 ease, ep_u64 press, ep_f64 p) noexcept {
            ease = std::clamp<ep_u64>(ease, 0, 2);
            press = std::clamp<ep_u64>(ease, 0, 10);
            return getIntegralValue(intTable[ease][press], ktIntegralTableSize, p);
        }
    };
...
static constexpr ep_u64 MilNoteTextureDescAttrType = 0;
static constexpr ep_u64 MilNoteTextureDescAttrIsHold = 1;
static constexpr ep_u64 MilNoteTextureDescAttrIsSimul = 2;
static constexpr ep_u64 MilNoteTextureDescAttrIsAlwaysPerfect = 3;
...
MilChartLoadResult loadMilChartFromDevJson(const Data& data) {
    ...
    for (auto& animNode : jsonRoot["animations"].getArray()) {
        ...
        if (press != 0) {
            ...
            e.easingFunc = [](void* ctx, ep_f64 p) {
                auto [ease, press] = EaseSet::Milthm::unpack((ep_u64)ctx);
                return EaseSet::Milthm::easing(ease, press, p);
            };

            e.easingIntFunc = [](void* ctx, ep_f64 p) {
                auto [ease, press] = EaseSet::Milthm::unpack((ep_u64)ctx);
                ...
                for (const auto isSimul : { false, true }) {
                    for (const auto isAlwaysPerfect : { false, true }) {
                        ...
                        calcConfig.noteTextureInfos[desc] = {
                            .textureSize = { (ep_f64)decoded.width, (ep_f64)decoded.height },
                            .cutPadding = loadResult.cutPadding,
                            .scaling = loadResult.scaling
                        };
...
namespace easy_phi {
    ...
    struct PhiStaticResourceHelpers {
        static PhiTakeOverer::NoteTextureDataLoaderResult noteTextureDataLoader(const PhiTakeOverer::NoteTextureDataLoaderConfig& config) {
            ...
            ep_f64 cutPadding = config.isSimul ? 100.0 : 50.0;
...
namespace easy_phi {
    ...
    struct MilStaticResourceHelpers {
        ...
        static MilTakeOverer::NoteTextureDataLoaderResult noteTextureDataLoader(const MilNoteTextureDesc& config) {
            ...
            auto data = MilStaticResource::get(key);
